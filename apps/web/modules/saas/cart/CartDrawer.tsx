...
export function CartDrawer({ trigger, isOpen: externalIsOpen, onClose }: CartDrawerProps) {
  ...
  const { cart, isLoading, updateCartItem, removeFromCart, clearCart, getTotalItems } = useCart();
