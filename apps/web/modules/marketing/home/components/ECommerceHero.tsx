			...
			<div className="container mx-auto px-4 py-20">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
					...
					<div className="space-y-8">
						...
						<div className="space-y-4">
							...
							<p className="text-xl text-gray-600 leading-relaxed max-w-lg">
								...
								fast delivery, secure payments, and unbeatable
								prices. Your shopping journey starts here.
							</p>
						</div>
					...
					<div className="relative">
						...
						<div className="absolute inset-0 bg-gradient-to-r from-blue-400/20 to-purple-400/20 rounded-3xl transform rotate-6" />
						<div className="absolute inset-0 bg-gradient-to-r from-purple-400/20 to-pink-400/20 rounded-3xl transform -rotate-6" />
