            ...
            <TableBody>
              {filteredCategories.map((category) => (
                <TableRow key={category.id}>
                  ...
                  <TableCell>
                    {category.parent ? (
                      <Badge status="info">{category.parent}</Badge>
                    ) : (
                  ...
                  <TableCell>
                    <Badge status={category.isActive ? "success" : "error"}>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                          <Link href={`/app/admin/categories/${category.id}`}>
                            View Details
                          </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                          <Link href={`/app/admin/categories/${category.id}/edit`}>
                            Edit Category
                          </Link>
                        </DropdownMenuItem>
