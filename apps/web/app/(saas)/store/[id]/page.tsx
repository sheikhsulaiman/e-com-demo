...
export default function ProductPage() {
	...
	const mockProduct: Product = {
		...
		description:
			"Experience premium sound quality with these wireless headphones featuring active noise cancellation, 30-hour battery life, and premium comfort design. Perfect for music, calls, and entertainment.",
	...
	const mockReviews: Review[] = [
		{
			...
			rating: 5,
			comment:
				"Excellent sound quality and comfort. The noise cancellation is amazing!",
			createdAt: new Date(
		...
		},
		{
			...
			rating: 4,
			comment:
				"Great headphones, but could be a bit lighter. Sound quality is superb.",
			createdAt: new Date(
		...
		},
		{
			...
			rating: 5,
			comment:
				"Worth every penny. The battery life is incredible and they're so comfortable.",
			createdAt: new Date(
