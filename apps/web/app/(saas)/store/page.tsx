...
import {
	ProductGrid,
	ProductList,
} from "../../../modules/saas/cart/ProductCard";
...
export default function StorePage() {
	...
	const mockProducts: Product[] = [
		...
		},
		{
			...
			description:
				"Comfortable ergonomic office chair with lumbar support, adjustable height, and breathable mesh back for all-day comfort.",
		...
		},
		{
			...
			description:
				"Soft, comfortable, and eco-friendly organic cotton t-shirt. Available in multiple colors and sizes.",
	...
	const filteredProducts = products
		.filter((product) => {
			...
			return (
				matchesSearch && matchesCategory && product.status === "ACTIVE"
			);
		})
		.sort((a, b) => {
			switch (sortBy) {
